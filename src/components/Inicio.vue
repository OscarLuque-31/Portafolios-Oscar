    ...
    <div id="presentacion">
        <div class="tarjetaPersonal">
            <section class="nombre">
                <h1>Óscar Luque Hidalgo</h1>
                <p><span class="resaltar">Software Developer</span></p>
            </section>
        </div>
    </div>
    <div id="sobremi">
            ...
            <section class="redes">
                <div class="redes_cv">
                    ...
                    <a href="/CV_Oscar.pdf" download="CV_OscarLuque.pdf" class="btnCV">
                        ...
                        <span class="textCV">Descargar CV</span>
                    </a>

                </div>
                <div class="redes_iconos">
                    <a href="https://github.com/OscarLuque-31" class="aRedes"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="https://www.linkedin.com/in/%C3%B3scar-luque-4074872a6/" class="aRedes"><svg
                    ...
                    <a href="mailto:oscarluquehidalgo@gmail.com" class="aRedes"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px"
                            height="50px">
                            <path fill="currentColor"
